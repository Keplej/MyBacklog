      ...
      <section id="sec">
        ...
        <ul>
          <li>
            ...
            <Button className={classes.buttonEdit} fullWidth variant="contained" color="secondary" onClick={() => {history.push('/current')}}>Currently</Button>
          </li>
          <li><span class="fa fa-music"></span>
            ...
            <Button className={classes.buttonEdit} fullWidth variant="contained" color="secondary" onClick={() => {history.push('/backlog')}}>Backlog</Button>
          </li>
          <li><span class="fa fa-users"></span>
            ...
            <Button className={classes.buttonEdit} fullWidth variant="contained" color="secondary" onClick={() => {history.push('/completed')}}>Completed</Button>
            </li>
        </ul>
      </section>
    </div>
